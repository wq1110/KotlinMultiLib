...
/**
 * Similar to [java.util.LinkedHashMap] when access ordered except that it is access ordered
 ...
 *
 *
 * For the purposes of the LRU, we count gets for a particular size of bitmap as an access, even
...
internal class GroupedLinkedMap<K : Poolable?, V> {
    ...
    private class LinkedEntry<K, V> @JvmOverloads constructor(key: K? = null) {
        val key: K
