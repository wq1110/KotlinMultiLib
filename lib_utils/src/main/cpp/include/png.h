...
/* Section 2: start time configuration
 ...
 * at start time for those applications that need to handle I/O in a
 ...
 * read or just write; in that case you may see an error at start time.  You can
...
#define PNG_IMAGE_PNG_SIZE_MAX(image)\
    ...
    * start out of buffer space but return a corrected size which should work.
    */
 ...
 *           are detected at start time, however sometimes it may be impossible
